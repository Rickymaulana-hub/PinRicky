    ...
    <section class="mt-14">
        <div class="max-w-[364px] bg-white rounded-md shadow-md mx-auto px-6 py-4">
            <div class="flex flex-col">
                ...
                <button type="submit" class="w-full py-1 mt-4 text-center text-white rounded-full bg-green-500">Register</button>
                <h5 class="mx-auto mt-4 text-xs text-center">Sudah punya akun? <a href="/login" class="text-blue-500">Log in</a></h5>
            </div>
        </div>
    </section>
    </form>
